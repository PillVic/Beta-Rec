...
import static com.betarec.data.UserMovieVectorMap.getUserVecMap;
...
public class TestModel {
    ...
    public void testGetUserVecs() {
        ...
        Map<Integer, INDArray> userVecMap = getUserVecMap(userIds);
    ...
    public void testCosine() {
        ...
        Map<Integer, INDArray> userVecMap = getUserVecMap(ids);

        Map<Integer, INDArray> movieVecMap = getMovieVecMap(ids);
